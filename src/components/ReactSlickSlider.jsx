...
const ReactSlickSlider = () => {
  ...
  const settings = {
    ...
    responsive: [
      {
        breakpoint: 768, // Devices with width <= 768px
        settings: {
          slidesToShow: 1,
          centerPadding: "0px",
        },
      ...
      {
        breakpoint: 1024, // Devices with width <= 1024px
        settings: {
          slidesToShow: 2,
          centerPadding: "0px",
        },
  ...
  const images = [ design0, design1, design2, design3, design4, design5, design8, design9, design10, design11, design12];

  return (
    <div className="w-[98%] h-[365px] mx-auto bg-gradient-to-l from-black to-slate-600 rounded-lg px-8 py-5 ">
      <Slider {...settings}>
